...
class AdaptivePPOAgent:
    ...
    def train_adaptive(self, n_iterations=50, n_steps_per_iteration=2048, 
                       initial_human_episodes=5, intervention_episodes=3,
        ...
        for i in range(n_iterations):
            ...
            if len(self.reward_window) > 0:
                ...
                print(f"Iteration {i+1}/{n_iterations}, Mean Reward (window): {mean_reward:.2f}, Best: {self.best_reward:.2f}, Worse Count: {self.consecutive_worse_iterations}")
